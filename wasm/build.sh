...
if [[ $webgpu -eq 1 ]]; then
    ...
    jspi_exports=(
        ...
        "yzma_get_embeddings_ith"
        "yzma_get_embeddings"
        "yzma_get_logits_ith"
        "yzma_get_logits"
        "yzma_sampler_sample"
        "yzma_set_sampler"
        "yzma_get_sampled_token_ith"
        "yzma_get_sampled_probs_ith"
        "yzma_get_sampled_probs_count_ith"
        "yzma_get_sampled_logits_ith"
        "yzma_get_sampled_logits_count_ith"
        "yzma_get_sampled_candidates_ith"
        "yzma_get_sampled_candidates_count_ith"
        "yzma_state_get_size"
        "yzma_state_get_data"
        "yzma_state_set_data"
        "yzma_state_seq_get_size_ext"
        "yzma_state_seq_get_data_ext"
        "yzma_state_seq_set_data_ext"
